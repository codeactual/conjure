...
Process.prototype.spawn = function() {
  ...
  cliMod.console.set('namespace', 'conjure').set('verboseLogName', label);
  this.stdout = cliMod.console.create(label, console.log);
  this.stderr = cliMod.console.create(label, console.error, 'red');
  this.verbose = cliMod.createVerbose(console.log);
