...
Conjure.prototype.configureBddflow = function(name, cb) {
  ...
  this.flow.addRootDescribe('initial URL/selector', function conjureRootDescribe() {
...
Conjure.prototype.injectHelpers = function() {
  ...
  Object.keys(helpers).forEach(function(key) {
    ...
    self.conjure[key] = function conjureInjectHelperWrap() {
      // It seems like pushStatus/popStatus should each be wrapped in a
      // CasperJS `then()`, but doing so leads to timeout (even with empty
      // callbacks).
