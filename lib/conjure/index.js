...
module.exports = {
  Conjure: Conjure,
  create: function(requireCasper) { return new Conjure(requireCasper); },
  mixinConjure: function(ext) { require('extend')(Conjure.prototype, ext); },
  mixinHelpers: function(ext) { require('extend')(helpers, ext); },

  // Allow tests to use/stub component-land require.
  require: require,
